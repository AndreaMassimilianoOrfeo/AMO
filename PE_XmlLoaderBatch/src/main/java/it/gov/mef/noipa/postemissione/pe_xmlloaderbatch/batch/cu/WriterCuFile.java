...
public class WriterCuFile implements ItemWriter<Object> {
	...
	public void write(List<? extends Object> items) throws Exception {
		...
		LOG.info(">>>>> DB_ELASTICSEARCH_CLUSTERNAME : " + System.getProperty("DB_ELASTICSEARCH_CLUSTERNAME"));
		LOG.info(">>>>> DB_ELASTICSEARCH_STORICO_CLUSTERNAME : " +System.getProperty("DB_ELASTICSEARCH_STORICO_CLUSTERNAME"));
		...
		for (Object item : items) {
			...
			} else if (item.getClass().equals(it.gov.mef.noipa.postemissione.parser.autogenerated.cu.cu.Cedolini.class)) {
				LOG.info("Elaborazione CUD");

				mapCud((it.gov.mef.noipa.postemissione.parser.autogenerated.cu.cu.Cedolini) item);
			}
		}
	...
	private void mapCud(it.gov.mef.noipa.postemissione.parser.autogenerated.cu.cu.Cedolini item) throws Exception {
		int i = 1;

		try {
			
			List <Cu> listaCud = item.getCu() ;
			...
			for (Cu cu : listaCud) {
				...
				//TODO IMPOSTARE SUL CUD DOCUMENT ANCHE LE SEGUENTI INFORMAZIONI
				//     	"dataProduzione": formato YYYYMM
				//		"sistemaProvenienza"	: fisso "SPT",
