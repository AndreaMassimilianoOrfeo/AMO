...
@Component
public class ServiceFacadeElasticSearchMocked implements IServiceFacadeElasticSearch {
	...
	@Override
	public void insertCedolino(String anno, Map<String, Ced> mappaCedolinoDocument,
