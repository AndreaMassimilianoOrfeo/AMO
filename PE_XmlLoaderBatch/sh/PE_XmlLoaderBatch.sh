...
Elaborazione()
{ 
  param=" carica.artefatti.oracle=false input.dir=$POSTEMISSIONE_HOME/postemissione_file/cedolinoxml/daelaborare file.lavorati.dir=$POSTEMISSIONE_HOME/postemissione_file/cedolinoxml/elaborati land.dir=$POSTEMISSIONE_HOME/postemissione_file/land/daelaborare time=$(date +"%s")" #PARAMETRI_CMD
  ...
  nohup $JAVA_POSTEMISSIONE_HOME/bin/java -Xmx1024m -cp $POSTEMISSIONE_HOME/postemissione/batch/jar/PE_XmlLoaderBatch.jar org.springframework.batch.core.launch.support.CommandLineJobRunner PE_XmlLoaderBatchJob.xml launcherBatchJob ${param} >> ${LOGFILE} &
}
