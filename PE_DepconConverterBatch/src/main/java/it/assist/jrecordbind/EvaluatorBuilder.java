...
class EvaluatorBuilder {
  ...
  static final class EnumerationRestrictionEval implements Evaluator<Property, XSSimpleType> {
    ...
    public void eval(Property target, XSSimpleType source) {
      ...
      XSFacet facet = source.getFacet("enumeration");
      if (facet!=null) {
...
//      separator = separator != null ? separator : "\n";
     separator = separator != null ? separator : System.getProperty("line.separator");
  ...
  static final class NillableEval implements Evaluator<Property, XSElementDecl> {

	    public void eval(Property target, XSElementDecl source) {
	      target.setNillable(source.isNillable());
	    }
	  }
  ...
  static final class SimpleRestrictionEval implements Evaluator<Property, XSSimpleType> {
    ...
    public void eval(Property target, XSSimpleType source) {
      if (source.getFacet("enumeration")!=null) {
  ...
  public EvaluatorBuilder() {
    ...
    propertiesEvals.add(new NillableEval());
    ...
    simpleTypePropertiesEvals.add(new NillableEval());
