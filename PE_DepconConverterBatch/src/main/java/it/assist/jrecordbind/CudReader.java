...
public class CudReader implements LineReader {

	private Logger logger = Logger.getLogger(CudReader.class);
   ...
   /* New code*/
	...
	public String readLine(BufferedReader reader) {
		...
		while(current!=null){
			...
			if(current==null || current.equals("$CUD1$")) break;
			buffer.append(current).append("\n");
